...
def train_and_evaluate_svm(train_texts, train_labels, test_texts, test_labels, num_epochs=5):
    ...
    for epoch in range(num_epochs):
        ...
        # Train both models on their respective subsets of the training data
        ...
        combined_labels_a = [pred if pred == true else true for pred, true in zip(preds_b, encoded_train_labels)]
        combined_labels_b = [pred if pred == true else true for pred, true in zip(preds_a, encoded_train_labels)]
